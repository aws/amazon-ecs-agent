...
`sudo amazon-linux-extras install -y ecs; sudo systemctl enable --now ecs`. This is the recommended way to run it in this environment.
...
#TODO: Add some default values for some of the low-level environment variables
