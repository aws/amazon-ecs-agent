...
| `ECS_AGENT_DOCKER_SECURITY_OPTS` | `label:value` | A list of string values to customize labels for MLS systems, such as SELinux. | `label:value` | `label:value` |
=======
| `ECS_AGENT_DOCKER_SECURITY_OPTS`   | `label:value` | A comma-separated list of string values to customize labels for MLS systems, such as SELinux. | `label:value` | `label:value` |
>>>>>>> 45c84ee0 (fix formatting error)
### Persistence
