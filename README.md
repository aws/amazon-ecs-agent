...
| `CREDENTIALS_FETCHER_HOST`   | `unix:///var/credentials-fetcher/socket/credentials_fetcher.sock` | Used to create a connection to the Credentials-fetcher daemon; to support. gMSA on Linux. | `unix:///var/credentials-fetcher/socket/credentials_fetcher.sock` | Not Applicable |
### Persistence
