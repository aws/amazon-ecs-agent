...
| `ECS_ENABLE_UNTRACKED_IMAGE_CLEANUP` | `true` | Whether to enable cleanup non-ecs container and non-ecs images  | `false` | `false` |
| `NONECS_NUM_CONTAINERS_DELETE_PER_CYCLE` | 5 | The maximum number of non-acs containers  to delete in a single automated cleanup cycle. | 5 | 5 |
