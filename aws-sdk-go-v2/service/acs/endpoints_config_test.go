...
func TestResolveBaseEndpoint(t *testing.T) {
    cases := map[string]struct {
        ...
        "env ignore": {
            ...
            envService: "https://env-acs.dev",
            envIgnore: true,
            configGlobal: "http://config-global.dev",
            configService: "http://config-acs.dev",
            expectURL: nil,
        },
        "env global": {
            envGlobal: "https://env-global.dev",
        ...
        "env service": {
            ...
            configGlobal: "http://config-global.dev",
            configService: "http://config-acs.dev",
            expectURL: aws.String("https://env-acs.dev"),
        },
        "config ignore": {
            envGlobal:     "https://env-global.dev",
            envService:    "https://env-acs.dev",
        ...
        "config service": {
            configGlobal:  "http://config-global.dev",
            configService: "http://config-acs.dev",
            expectURL:     aws.String("http://config-acs.dev"),
        },
        "client": {
            envGlobal:     "https://env-global.dev",
            envService:    "https://env-acs.dev",
            configGlobal:  "http://config-global.dev",
            configService: "http://config-acs.dev",
            clientEndpoint: aws.String("https://client-acs.dev"),
            expectURL:     aws.String("https://client-acs.dev"),
        },
    }
    ...
    for name, c := range cases {
        t.Run(name, func(t *testing.T) {
            ...
            if c.envService != "" {
                t.Setenv("AWS_ENDPOINT_URL_ACS", c.envService)
            }
