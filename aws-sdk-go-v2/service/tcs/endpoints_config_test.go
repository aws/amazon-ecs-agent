...
func TestResolveBaseEndpoint(t *testing.T) {
    cases := map[string]struct {
        ...
        "env ignore": {
            ...
            envService: "https://env-tcs.dev",
            envIgnore: true,
            configGlobal: "http://config-global.dev",
            configService: "http://config-tcs.dev",
            expectURL: nil,
        },
        "env global": {
            envGlobal: "https://env-global.dev",
        ...
        "env service": {
            ...
            configGlobal: "http://config-global.dev",
            configService: "http://config-tcs.dev",
            expectURL: aws.String("https://env-tcs.dev"),
        },
        "config ignore": {
            envGlobal:     "https://env-global.dev",
            envService:    "https://env-tcs.dev",
        ...
        "config service": {
            configGlobal:  "http://config-global.dev",
            configService: "http://config-tcs.dev",
            expectURL:     aws.String("http://config-tcs.dev"),
        },
        "client": {
            envGlobal:     "https://env-global.dev",
            envService:    "https://env-tcs.dev",
            configGlobal:  "http://config-global.dev",
            configService: "http://config-tcs.dev",
            clientEndpoint: aws.String("https://client-tcs.dev"),
            expectURL:     aws.String("https://client-tcs.dev"),
        },
    }
    ...
    for name, c := range cases {
        t.Run(name, func(t *testing.T) {
            ...
            if c.envService != "" {
                t.Setenv("AWS_ENDPOINT_URL_TCS", c.envService)
            }
