...
func TestInvalidInstanceException(t *testing.T) {
	...
	err := acsErr.NewError(&types.InvalidInstanceException{Message: &errMsg})
...
func TestInvalidClusterException(t *testing.T) {
	...
	err := acsErr.NewError(&types.InvalidClusterException{Message: &errMsg})
...
func TestServerException(t *testing.T) {
	err := acsErr.NewError(&types.ServerException{Message: nil})
