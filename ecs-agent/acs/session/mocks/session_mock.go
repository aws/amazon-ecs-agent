...
// Source: github.com/aws/amazon-ecs-agent/ecs-agent/acs/session (interfaces: ENIHandler,ResourceHandler,CredentialsMetadataSetter,PayloadMessageHandler,ManifestMessageIDAccessor,TaskComparer,SequenceNumberAccessor)
...
func (m *MockSequenceNumberAccessor) SetLatestSequenceNumber(arg0 *ecsacs.TaskManifestMessage) error {
	m.ctrl.T.Helper()
