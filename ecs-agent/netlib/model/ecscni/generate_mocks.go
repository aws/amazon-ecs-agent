...
//go:generate mockgen -destination=mocks_nsutil/nsutil_mocks.go -copyright_file=../../../../scripts/copyright_file github.com/aws/amazon-ecs-agent/ecs-agent/netlib/model/ecscni NetNSUtil
