...
func TestNewHttpClient(t *testing.T) {
	expectedResult := New(time.Duration(10), true, agentVersionStr, osType, detailedOSFamily)
...
func TestNewHttpClientProxy(t *testing.T) {
	...
	client := New(time.Duration(10*time.Second), true, agentVersionStr, osType, detailedOSFamily)
