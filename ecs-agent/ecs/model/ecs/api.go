...
type ContainerDefinition struct {
	...
	// replaced with "sensitive" in string returned by ContainerDefinition's
	// String and GoString methods.
	Environment []*KeyValuePair `locationName:"environment" type:"list" sensitive:"true"`
...
type ContainerOverride struct {
	...
	//
	// Environment is a sensitive parameter and its value will be
	// replaced with "sensitive" in string returned by ContainerOverride's
	// String and GoString methods.
	Environment []*KeyValuePair `locationName:"environment" type:"list" sensitive:"true"`
