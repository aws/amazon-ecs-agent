...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/tcs/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
        ...
        _, s := os.LookupEnv("AWS_ENDPOINT_URL_TCS")

        if g && !s  {
            return
        }

        value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "TCS", cfg.ConfigSources)
        if found && err == nil {
...
out.WriteString("https://ecstcs-fips.")
