...
const ServiceID = "TCS"
const ServiceAPIVersion = "2015-03-10"
...
func withOperationMetrics(parent context.Context, mp metrics.MeterProvider) (context.Context, error) {
    meter := mp.Meter("github.com/aws/aws-sdk-go-v2/service/tcs")
    om := &operationMetrics{}
...
func operationTracer(p tracing.TracerProvider) tracing.Tracer {
    return p.Tracer("github.com/aws/aws-sdk-go-v2/service/tcs")
}

// Client provides the API client to make operations call for Amazon EC2 Container
// Service Telemetry Communication Service.
type Client struct {
    options Options
...
finalizeClientEndpointResolverOptions(&options)
    ...
    handler := smithyhttp.NewClientHandlerWithOptions(options.HTTPClient, func(o *smithyhttp.ClientHandler) {
        o.Meter = options.MeterProvider.Meter("github.com/aws/aws-sdk-go-v2/service/tcs")
    })
...
func addClientUserAgent(stack *middleware.Stack, options Options) error {
    ...
    ua.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "tcs", goModuleVersion)
...
func addRetry(stack *middleware.Stack, o Options) error {
    attempt := retry.NewAttemptMiddleware(o.Retryer, smithyhttp.RequestCloner, func(m *retry.Attempt) {
        ...
        m.OperationMeter = o.MeterProvider.Meter("github.com/aws/aws-sdk-go-v2/service/tcs")
    })
