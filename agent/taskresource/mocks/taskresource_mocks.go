...
func (m *MockTaskResource) BuildContainerDependency(arg0 string, arg1 containerstatus.ContainerStatus, arg2 status0.ResourceStatus) {
	m.ctrl.T.Helper()
...
func (m *MockTaskResource) GetAppliedStatus() status0.ResourceStatus {
	m.ctrl.T.Helper()
...
func (m *MockTaskResource) GetContainerDependencies(arg0 status0.ResourceStatus) []containerresource.ContainerDependency {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetContainerDependencies", arg0)
	ret0, _ := ret[0].([]containerresource.ContainerDependency)
	return ret0
}
