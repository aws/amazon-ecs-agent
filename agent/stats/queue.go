...
type Queue struct {
	buffer                []UsageStats
	maxSize               int
	lastStat              *container.StatsResponse
...
func (queue *Queue) AddContainerStat(dockerStat *container.StatsResponse, nonDockerStats NonDockerContainerStats,
	lastStatBeforeLastRestart *container.StatsResponse, containerHasRestartedBefore bool) error {
...
func (queue *Queue) Add(dockerStat *container.StatsResponse, nonDockerStats NonDockerContainerStats) error {
...
func (queue *Queue) setLastStat(stat *container.StatsResponse) {
	queue.lock.Lock()
	defer queue.lock.Unlock()
...
func (queue *Queue) GetLastStat() *container.StatsResponse {
	queue.lock.RLock()
...
func getAggregatedDockerStatAcrossRestarts(dockerStat, lastStatBeforeLastRestart,
	lastStatInStatsQueue *container.StatsResponse) *container.StatsResponse {
...
func aggregateOSIndependentStats(dockerStat, lastStatBeforeLastRestart *container.StatsResponse) *container.StatsResponse {
	// CPU stats.
