...
func (engine *MockTaskEngine) GetEbsDaemonTask() *apitask.Task {
	return nil
}

func (engine *MockTaskEngine) SetEbsDaemonTask(*apitask.Task) {
}

func (engine *MockTaskEngine) EmitTaskEvent(*apitask.Task, string) {
}
