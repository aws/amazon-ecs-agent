...
type Engine interface {
	...
	ContainerDockerStats(taskARN string, containerID string) (*container.StatsResponse, *stats.NetworkStatsPerSec, error)
...
func (engine *DockerStatsEngine) ContainerDockerStats(taskARN string, containerID string) (*container.StatsResponse, *stats.NetworkStatsPerSec, error) {
	engine.lock.RLock()
	defer engine.lock.RUnlock()
