...
func TestFirelensRouterFluentdCapabilitiesUnix(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
	...
	expectedCapabilities = append(expectedCapabilities,
		[]*ecs.Attribute{
			...
			{
				Name: aws.String(attributePrefix+capabilityFirelensRouterFluentd),
			},
		}...)
	ctx, cancel := context.WithCancel(context.TODO())
	// Cancel the context to cancel async routines
...
func TestFirelensRouterFluentbitCapabilitiesUnix(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
	...
	expectedCapabilities = append(expectedCapabilities,
		[]*ecs.Attribute{
			...
			{
				Name: aws.String(attributePrefix+capabilityFirelensRouterFluentbit),
			},
		}...)
	ctx, cancel := context.WithCancel(context.TODO())
	// Cancel the context to cancel async routines
...
func TestFirelensLoggingDriverCapabilitiesUnix(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
