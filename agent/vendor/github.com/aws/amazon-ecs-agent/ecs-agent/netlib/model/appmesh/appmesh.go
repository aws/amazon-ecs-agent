...
const (
	appMesh                    = acstypes.ProxyConfigurationTypeAppmesh
	splitter                   = ","
...
func AppMeshFromACS(proxyConfig *acstypes.ProxyConfiguration) (*AppMesh, error) {
...
func buildAppPorts(proxyConfig *acstypes.ProxyConfiguration) []string {
