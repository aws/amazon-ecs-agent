...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/acs/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
        ...
        _, s := os.LookupEnv("AWS_ENDPOINT_URL_ACS")

        if g && !s  {
            return
        }

        value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "ACS", cfg.ConfigSources)
        if found && err == nil {
...
out.WriteString("https://ecsacs-fips.")
