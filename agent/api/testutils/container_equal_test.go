...
func TestContainerEqual(t *testing.T) {
	...
	equalPairs := []Container{
		...
		{DesiredStatus: ContainerRunning}, {DesiredStatus: ContainerRunning},
		{AppliedStatus: ContainerRunning}, {AppliedStatus: ContainerRunning},
		{KnownStatus: ContainerRunning}, {KnownStatus: ContainerRunning},
	...
	unequalPairs := []Container{
		...
		{DesiredStatus: ContainerRunning}, {DesiredStatus: ContainerStopped},
		{AppliedStatus: ContainerRunning}, {AppliedStatus: ContainerStopped},
		{KnownStatus: ContainerRunning}, {KnownStatus: ContainerStopped},
