...
func TestContainerEqual(t *testing.T) {
	...
	equalPairs := []Container{
		...
		Container{BindMounts: []string{"1", "2"}}, Container{BindMounts: []string{"1", "2"}},
		Container{BindMounts: []string{"1", "2"}}, Container{BindMounts: []string{"2", "1"}},
		Container{VolumesFrom: []string{"1", "2"}}, Container{VolumesFrom: []string{"1", "2"}},
		Container{VolumesFrom: []string{"1", "2"}}, Container{VolumesFrom: []string{"2", "1"}},
	...
	unequalPairs := []Container{
		...
		Container{BindMounts: []string{"1", "2"}}, Container{BindMounts: []string{"1", "二"}},
		Container{VolumesFrom: []string{"1", "2"}}, Container{VolumesFrom: []string{"1", "二"}},
