...
func (client *APIECSClient) RegisterContainerInstance(containerInstanceArn string,
	attributes []*ecs.Attribute, registrationToken string) (string, error) {
	...
	if clusterRef == "" {
		...
		containerInstanceArn, err := client.registerContainerInstance(clusterRef, containerInstanceArn, attributes, registrationToken)
		if err == nil {
	...
	return client.registerContainerInstance(clusterRef, containerInstanceArn, attributes, registrationToken)
}
