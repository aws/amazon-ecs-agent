...
type ContainerStateChange struct {
	...
	// Type indicates container state change
	Type statechange.EventType
}

// ManagedAgentStateChange represents a state change that needs to be sent to the
...
type ManagedAgentStateChange struct {
	...
	Reason string
	// Type indicates managed agent state change
	Type statechange.EventType
}
...
type TaskStateChange struct {
	...
	// ManagedAgents holds the events as part of this task
	ManagedAgents []ManagedAgentStateChange
