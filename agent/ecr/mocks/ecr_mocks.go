...
func (m *MockECRFactory) GetClient(arg0, arg1 string) ecr.ECRClient {
...
func (m *MockECRClient) IsTokenValid(arg0 *ecr0.AuthorizationData) bool {
...
func (mr *MockECRClientMockRecorder) IsTokenValid(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsTokenValid", reflect.TypeOf((*MockECRClient)(nil).IsTokenValid), arg0)
}
