...
// Source: github.com/aws/amazon-ecs-agent/agent/s3/factory/factory.go
...
func (m *MockS3ClientCreator) NewS3Client(bucket, region string, creds credentials.IAMRoleCredentials) (s3.S3Client, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewS3Client", bucket, region, creds)
...
func (mr *MockS3ClientCreatorMockRecorder) NewS3Client(bucket, region, creds interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewS3Client", reflect.TypeOf((*MockS3ClientCreator)(nil).NewS3Client), bucket, region, creds)
}

// NewS3ManagerClient mocks base method.
func (m *MockS3ClientCreator) NewS3ManagerClient(bucket, region string, creds credentials.IAMRoleCredentials) (s3.S3ManagerClient, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewS3ManagerClient", bucket, region, creds)
...
func (mr *MockS3ClientCreatorMockRecorder) NewS3ManagerClient(bucket, region, creds interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewS3ManagerClient", reflect.TypeOf((*MockS3ClientCreator)(nil).NewS3ManagerClient), bucket, region, creds)
}
