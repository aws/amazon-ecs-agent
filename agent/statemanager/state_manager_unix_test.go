...
func TestLoadsDataForGMSATask(t *testing.T) {
	...
	taskEngine := engine.NewTaskEngine(&config.Config{}, nil, nil, nil, nil, taskEngineState, nil, nil, nil)
	var containerInstanceArn, cluster, savedInstanceID string
	var sequenceNumber int64
	...
	testCredSpec := "credentialspec:arn:aws:secretsmanager:us-west-2:1234567890:secret:gmsacredspec-TN9W0q"
