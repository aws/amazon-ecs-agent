...
func (_m *MockResult) PrintTo(_param0 io.Writer) error {
	ret := _m.ctrl.Call(_m, "PrintTo", _param0)
	ret0, _ := ret[0].(error)
	return ret0
}

func (_mr *_MockResultRecorder) PrintTo(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "PrintTo", arg0)
}
