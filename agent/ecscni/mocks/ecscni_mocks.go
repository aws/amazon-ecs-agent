...
func (_m *MockCNIClient) ReleaseIPResource(_param0 context.Context, _param1 *ecscni.Config, _param2 time.Duration) error {
	ret := _m.ctrl.Call(_m, "ReleaseIPResource", _param0, _param1, _param2)
	ret0, _ := ret[0].(error)
	return ret0
}

func (_mr *_MockCNIClientRecorder) ReleaseIPResource(arg0, arg1, arg2 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "ReleaseIPResource", arg0, arg1, arg2)
}
