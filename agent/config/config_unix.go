...
func DefaultConfig() Config {
	return Config{
		...
		PrometheusMonitorContainerTarballPath: prometheusMonitorContainerTarballPath,
		PrometheusMonitorContainerImageName:   prometheusMonitorContainerImageName,
		PrometheusMonitorContainerTag:         prometheusMonitorContainerImageTag,
		PrometheusMonitorVolumeName:           prometheusMonitorVolumeName,
