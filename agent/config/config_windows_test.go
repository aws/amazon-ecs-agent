...
func TestConfigDefault(t *testing.T) {
	...
	assert.Equal(t, uint32(0), cfg.ReservedMemory, "Default reserved memory set incorrectly")
	assert.Equal(t, uint32(0), cfg.ReservedCpu, "Default reserved memory set incorrectly")
