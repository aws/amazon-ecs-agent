...
// in order to save into boltdb. Specifically, we need container to have its taskARN field populated.
// Task launched with new agent will have this field populated in PostUnmarshalTask, but task loaded
// from state file generated by old agent might not, which is why this is needed.
