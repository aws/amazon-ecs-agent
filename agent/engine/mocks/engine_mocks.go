...
// Source: github.com/aws/amazon-ecs-agent/agent/engine (interfaces: TaskEngine,ImageManager,EBSDaemonTaskAccessor,EBSDaemonTaskGetter,EBSDaemonTaskSetter)
...
// MockEBSDaemonTaskAccessor is a mock of EBSDaemonTaskAccessor interface.
type MockEBSDaemonTaskAccessor struct {
	ctrl     *gomock.Controller
	recorder *MockEBSDaemonTaskAccessorMockRecorder
}

// MockEBSDaemonTaskAccessorMockRecorder is the mock recorder for MockEBSDaemonTaskAccessor.
type MockEBSDaemonTaskAccessorMockRecorder struct {
	mock *MockEBSDaemonTaskAccessor
}

// NewMockEBSDaemonTaskAccessor creates a new mock instance.
func NewMockEBSDaemonTaskAccessor(ctrl *gomock.Controller) *MockEBSDaemonTaskAccessor {
	mock := &MockEBSDaemonTaskAccessor{ctrl: ctrl}
	mock.recorder = &MockEBSDaemonTaskAccessorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockEBSDaemonTaskAccessor) EXPECT() *MockEBSDaemonTaskAccessorMockRecorder {
	return m.recorder
}

// GetEbsDaemonTask mocks base method.
func (m *MockEBSDaemonTaskAccessor) GetEbsDaemonTask() *task.Task {
	m.ctrl.T.Helper()
...
func (mr *MockEBSDaemonTaskAccessorMockRecorder) GetEbsDaemonTask() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEbsDaemonTask", reflect.TypeOf((*MockEBSDaemonTaskAccessor)(nil).GetEbsDaemonTask))
}

// SetEbsDaemonTask mocks base method.
func (m *MockEBSDaemonTaskAccessor) SetEbsDaemonTask(arg0 *task.Task) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetEbsDaemonTask", arg0)
}

// SetEbsDaemonTask indicates an expected call of SetEbsDaemonTask.
func (mr *MockEBSDaemonTaskAccessorMockRecorder) SetEbsDaemonTask(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetEbsDaemonTask", reflect.TypeOf((*MockEBSDaemonTaskAccessor)(nil).SetEbsDaemonTask), arg0)
}

// MockEBSDaemonTaskGetter is a mock of EBSDaemonTaskGetter interface.
type MockEBSDaemonTaskGetter struct {
	ctrl     *gomock.Controller
	recorder *MockEBSDaemonTaskGetterMockRecorder
}

// MockEBSDaemonTaskGetterMockRecorder is the mock recorder for MockEBSDaemonTaskGetter.
type MockEBSDaemonTaskGetterMockRecorder struct {
	mock *MockEBSDaemonTaskGetter
}

// NewMockEBSDaemonTaskGetter creates a new mock instance.
func NewMockEBSDaemonTaskGetter(ctrl *gomock.Controller) *MockEBSDaemonTaskGetter {
	mock := &MockEBSDaemonTaskGetter{ctrl: ctrl}
	mock.recorder = &MockEBSDaemonTaskGetterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockEBSDaemonTaskGetter) EXPECT() *MockEBSDaemonTaskGetterMockRecorder {
	return m.recorder
}

// GetEbsDaemonTask mocks base method.
func (m *MockEBSDaemonTaskGetter) GetEbsDaemonTask() *task.Task {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEbsDaemonTask")
	ret0, _ := ret[0].(*task.Task)
	return ret0
...
// GetEbsDaemonTask indicates an expected call of GetEbsDaemonTask.
func (mr *MockEBSDaemonTaskGetterMockRecorder) GetEbsDaemonTask() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEbsDaemonTask", reflect.TypeOf((*MockEBSDaemonTaskGetter)(nil).GetEbsDaemonTask))
}

// MockEBSDaemonTaskSetter is a mock of EBSDaemonTaskSetter interface.
type MockEBSDaemonTaskSetter struct {
	ctrl     *gomock.Controller
	recorder *MockEBSDaemonTaskSetterMockRecorder
}

// MockEBSDaemonTaskSetterMockRecorder is the mock recorder for MockEBSDaemonTaskSetter.
type MockEBSDaemonTaskSetterMockRecorder struct {
	mock *MockEBSDaemonTaskSetter
}

// NewMockEBSDaemonTaskSetter creates a new mock instance.
func NewMockEBSDaemonTaskSetter(ctrl *gomock.Controller) *MockEBSDaemonTaskSetter {
	mock := &MockEBSDaemonTaskSetter{ctrl: ctrl}
	mock.recorder = &MockEBSDaemonTaskSetterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockEBSDaemonTaskSetter) EXPECT() *MockEBSDaemonTaskSetterMockRecorder {
	return m.recorder
}

// SetEbsDaemonTask mocks base method.
func (m *MockEBSDaemonTaskSetter) SetEbsDaemonTask(arg0 *task.Task) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetEbsDaemonTask", arg0)
}

// SetEbsDaemonTask indicates an expected call of SetEbsDaemonTask.
func (mr *MockEBSDaemonTaskSetterMockRecorder) SetEbsDaemonTask(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetEbsDaemonTask", reflect.TypeOf((*MockEBSDaemonTaskSetter)(nil).SetEbsDaemonTask), arg0)
}
