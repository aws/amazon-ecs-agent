...
type Manager interface {
	...
	Create(*containerSDK.Config, *containerSDK.HostConfig, *apitask.Task, string) error
...
func (manager *metadataManager) Create(config *containerSDK.Config, hostConfig *containerSDK.HostConfig, task *apitask.Task, containerName string) error {
